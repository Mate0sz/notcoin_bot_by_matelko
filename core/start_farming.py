...
class Farming:
    ...
    async def get_access_token(self,
        ...
        while True:
            try:
                ...
                if r:
                    logger.error(f'{self.session_name} | Nieznany błąd podczas odbierania Access Token: {error}, '
    ...
    async def get_tg_web_data(self,
        ...
        while True:
            try:
                ...
                logger.error(f'{self.session_name} | Nieznany błąd podczas odbierania: {error}')
        ...
        while True:
            try:
                ...
                if not (await r.json(content_type=None)).get('ok'):
                    logger.error(f'{self.session_name} | Nieznana odpowiedź podczas pobierania danych profilu, '
                                 f'ответ: {await r.text()}')
                    continue
                ...
                logger.error(f'{self.session_name} | Nieznana odpowiedź podczas pobierania danych profilu: {error}')
        ...
        while True:
            try:
                ...
                if (await r.json(content_type=None)).get('ok'):
                    logger.success(f'{self.session_name} | Udało się Click | Balance: '
                ...
                logger.error(f'{self.session_name} | Nie udało się kliknąć, odpowiedź: {await r.text()}')
                return None, None, None

            except Exception as error:
                logger.error(f'{self.session_name} | Nieznany błąd podczas próby wykonania kliknięcia: {error}')
    ...
    async def get_merged_list(self,
        ...
        try:
            ...
            logger.error(f'{self.session_name} | Nie udało się pobrać listy produktów, odpowiedź: {await r.text()}')

            return

        except Exception as error:
            if r:
                logger.error(f'{self.session_name} | Nieznany błąd podczas pobierania listy produktów: {error}, '
                             f'ответ: {await r.text()}')
    ...
    async def buy_item(self,
        ...
        try:
            ...
            logger.error(f'{self.session_name} | Nieznana reakcja podczas zakupów w sklepie: {await r.text()}')

            return False

        except Exception as error:
            if r:
                logger.error(f'{self.session_name} | Nieznany błąd podczas zakupów w sklepie: {error}, '
                             f'ответ: {await r.text()}')
    ...
    async def activate_turbo(self,
        ...
        try:
            ...
            if r:
                logger.error(f'{self.session_name} | Nieznany błąd podczas aktywacji Turbo: {error}, '
                             f'ответ: {await r.text()}')
    ...
    async def activate_task(self,
        ...
        try:
            ...
            logger.error(f'{self.session_name} | Nieznana odpowiedź podczas aktywacji zadania {task_id}: {await r.text()}')

            return False

        except Exception as error:
            if r:
                logger.error(f'{self.session_name} | Nieznana odpowiedź podczas aktywacji zadania {task_id}: {error}, '
                             f'ответ: {await r.text()}')
    ...
    async def get_free_buffs_data(self,
        ...
        try:
            ...
            if r:
                logger.error(f'{self.session_name} | Nieznany błąd podczas uzyskiwania statusu darmowego wzmocnienia: '
                        ...
                        try:
                            ...
                            if not active_turbo:
                                if config.MIN_CLICKS_COUNT > floor(profile_data['data'][0]['availableCoins'] \
                                    ...
                                    logger.info(f'{self.session_name} | Za mało monet, aby kliknąć')
                                    continue
                            ...
                            if have_turbo:
                                ...
                                logger.info(f'{self.session_name} | śpię {random_sleep_time} przed aktywacją '
                                            f'Turbo')
                                ...
                                if turbo_multiplier:
                                    logger.success(f'{self.session_name} | Pomyślnie aktywowano Turbo: '
                                            ...
                                            case 1:
                                                ...
                                                if new_balance >= energy_price \
                                                    ...
                                                    logger.info(f'{self.session_name} | Сплю {sleep_before_buy_merge} '
                                                                f'seк. przed zakupem Energy Boost')

                                                    await asyncio.sleep(delay=sleep_before_buy_merge)

                                                    if await self.buy_item(client=client,
                                                                           item_id=1):
                                                        logger.success(f'{self.session_name} | Zakupiony pomyślnie Energy '
                                                                       'Boost')
                                                        continue
                                            ...
                                            case 2:
                                                ...
                                                if new_balance >= speed_price \
                                                    ...
                                                    if await self.buy_item(client=client,
                                                                           item_id=2):
                                                        logger.success(
                                                            f'{self.session_name} | Zakupiony pomyślnie Speed Boost')
                                                        continue
                                            ...
                                            case 3:
                                                ...
                                                if new_balance >= click_price \
                                                    ...
                                                    sleep_before_buy_merge: int = randint(
                                                        ...
                                                        b=config.SLEEP_BEFORE_BUY_MERGE[1])
                                                    logger.info(
                                                        f'{self.session_name} | Сплю {sleep_before_buy_merge} sek. '
                                                        f'przed zakupem Speed Boost')
                                                    ...
                                                    if await self.buy_item(client=client,
                                                                           item_id=3):
                                                        logger.success(
                                                            f'{self.session_name} | Zakupiony pomyślnie Click Boost')
                                                        continue
                            ...
                            if free_daily_turbo:
                                ...
                                logger.info(f'{self.session_name} | śpię {random_sleep_time} przed prośbą '
                                            f'codziennie Turbo')
                                ...
                                if await self.activate_task(client=client,
                                                            task_id=3):
                                    logger.success(f'{self.session_name} | Pomyślnie zażądano codziennie Turbo')
                                ...
                                logger.info(f'{self.session_name} | śpię {random_sleep_time} przed aktywacja '
                                            f'codziennie Full Energy')

                                await asyncio.sleep(delay=random_sleep_time)

                                if await self.activate_task(client=client,
                                                            task_id=2):
                                    logger.success(f'{self.session_name} | Pomyślnie zażądano codziennie Full Energy')

                        except InvalidSession as error:
                            raise error

                        except Exception as error:
                            logger.error(f'{self.session_name} | Nieznany błąd: {error}')

                            random_sleep_time: int = randint(a=config.SLEEP_BETWEEN_CLICK[0],
                                                             b=config.SLEEP_BETWEEN_CLICK[1])

                            logger.info(f'{self.session_name} | śpię {random_sleep_time} sek.')
                            await asyncio.sleep(delay=random_sleep_time)
                            ...
                            logger.info(f'{self.session_name} | spie {random_sleep_time} sek.')
                            await asyncio.sleep(delay=random_sleep_time)
