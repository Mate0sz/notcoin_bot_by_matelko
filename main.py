...
async def main() -> None:
    ...
    match user_action:
        case 1:
            ...
            logger.success('Sesje zostały dodane pomyślnie')
        ...
        case _:
            logger.error('Akcja wybrana nieprawidłowo')
...
if __name__ == '__main__':
    ...
    logger.info(f'Odkryty {len(session_files)} sesje / {len(proxies)} proxy')
    print("""
...
""")
    user_action: int = int(input('\n1. Utwórz sesję'
                                 '\n2. Uruchom bota z istniejących sesji'
